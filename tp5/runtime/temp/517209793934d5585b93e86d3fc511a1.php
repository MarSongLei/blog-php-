<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"G:\blog\tp5\public/../application/admin\view\article\index.html";i:1505828471;s:63:"G:\blog\tp5\public/../application/admin\view\common\header.html";i:1505834230;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="100px">文章标题</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <?php if($v['pic'] != ''): ?>
                                                <img src="<?php echo $v['pic']; ?>" alt="无法显示" width="200px" height="100px">
                                                <?php else: ?>
                                                暂无缩略图
                                                 <?php endif; ?>
                                            </td>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url("Article/edit",array('id'=>$v['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <!--tp3不支持$v.id 这种写法-->
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Article/del",array('id'=>$v['id'])); ?>')" class="btn btn-danger btn-sm shiny">
