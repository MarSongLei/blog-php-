<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"G:\blog\tp5\public/../application/admin\view\tags\index.html";i:1505621191;s:63:"G:\blog\tp5\public/../application/admin\view\common\header.html";i:1505834230;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $d['tagname']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url("Tags/edit",array('id'=>$d['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <!--tp3不支持$v.id 这种写法-->
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Tags/del",array('id'=>$d['id'])); ?>')" class="btn btn-danger btn-sm shiny">
