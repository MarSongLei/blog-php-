<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"G:\blog\tp5\public/../application/admin\view\tags\add.html";i:1505621191;s:63:"G:\blog\tp5\public/../application/admin\view\common\header.html";i:1505834230;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Tags/index'); ?>">标签管理</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Tags/add'); ?>" method="post">
