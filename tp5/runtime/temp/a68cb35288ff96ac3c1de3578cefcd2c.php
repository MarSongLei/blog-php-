<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"G:\blog\tp5\public/../application/admin\view\login\login.html";i:1505734964;}*/ ?>
<!DOCTYPE html>
...
<div class="login-container animated fadeInDown">
    <form action="<?php echo url('Login/doLogin'); ?>" method="post">
        <div class="loginbox bg-white">
            ...
            <div class="loginbox-textbox"><img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>'" /></div>
