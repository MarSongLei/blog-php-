<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"G:\blog\tp5\public/../application/admin\view\article\add.html";i:1505750228;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="keywords" placeholder=""
                                                       name="keywords" type="text"></div>
                                            <p class="help-block col-sm-4 red">多个关键字用英文隔开</p>
                                        </div>
                                        <div class="form-group">
