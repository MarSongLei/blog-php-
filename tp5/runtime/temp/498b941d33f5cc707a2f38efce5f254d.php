<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"G:\blog\tp5\public/../application/admin\view\listing\listpage.html";i:1505834378;s:63:"G:\blog\tp5\public/../application/admin\view\common\header.html";i:1505834230;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url("Admin/edit",array('id'=>$v['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <!--tp3不支持$v.id 这种写法-->
                                                <?php if($v['id'] != 1): ?>
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Admin/del",array('id'=>$v['id'])); ?>')" class="btn btn-danger btn-sm shiny">
