<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"G:\blog\tp5\public/../application/admin\view\article\edit.html";i:1505750297;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Article/upd'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author" placeholder="" name="author"
                                                       value="<?php echo $data['author']; ?>" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid" style="width: 100%;" id="cateid">
                                                    <option  value="0">请选择</option>
                                                    <?php foreach($cateData as $v): ?>
                                                    <option value="<?php echo $v['id']; ?>"<?php if($v['id'] == $data['cateid']): ?> selected="selected" <?php endif; ?>>
                                                    <?php echo $v['catename']; ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="desc" id="desc" class="form-control"><?php echo $data['content']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="keywords"
                                            ...
                                            <p class="help-block col-sm-4 red">多个关键字用英文逗号隔开</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="pic" class="col-sm-2 control-label no-padding-right">缩略图</label>
                                            <div class="col-sm-6">
                                                <input  id="pic" placeholder="" name="pic"
                                                       value="2" type="file">
                                                <img src="<?php echo $data['pic']; ?>" alt="无法显示" width="200px" height="100px">
                                                </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="is_show"
