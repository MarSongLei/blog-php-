<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"G:\blog\tp5\public/../application/admin\view\tags\edit.html";i:1505621191;s:63:"G:\blog\tp5\public/../application/admin\view\common\header.html";i:1505743923;s:61:"G:\blog\tp5\public/../application/admin\view\common\left.html";i:1505632351;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title></title>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('Tags/upd'); ?>" method="post">
                                        <div class="form-group">
                                            <label for="tagname" class="col-sm-2 control-label no-padding-right">标签名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="tagname" placeholder="" name="tagname"  type="text" value="<?php echo $data['tagname']; ?>">
                                            </div>
